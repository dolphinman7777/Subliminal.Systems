          ...
          <div className="container px-4 md:px-6 mb-16">
            <div className="flex flex-col items-center space-y-8 text-center">
              <HyperText
                ...
                className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-400 dark:to-indigo-400 leading-relaxed py-2"
                duration={2000}
                animateOnLoad={false}
              />
              <div className="min-h-[4rem] h-auto py-2">
                <HyperText
                  text={mindSoftwareSentences[currentSentenceIndex]}
                  className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 font-mono leading-relaxed"
                  duration={1500}
                  animateOnLoad={false}
