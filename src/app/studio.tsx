...
export const Studio: React.FC = () => {
  ...
  useEffect(() => {
    // Any localStorage operations should be performed inside useEffect
    // This ensures they only run on the client-side
    const storedAudioDetails = localStorage.getItem('pendingAudioDetails');
    if (storedAudioDetails) {
      // Parse and use the stored audio details
      const parsedAudioDetails = JSON.parse(storedAudioDetails);
      // Update your state or perform any other actions with parsedAudioDetails
    }
